...
const BackendStack = () => {
  return (
    <div className='flex flex-col items-center justify-between w-full h-[650px] max-s:flex-row overflow-x-auto max-s:h-[400px]'>
      <div className='flex flex-row justify-between items-center w-full h-1/2'>
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>Node.js</span>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>JWT</span>
          <span className='techDescription w-full mt-[20px]'>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>Expresx.js</span>
          <span className='techDescription w-full mt-[20px]'>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>Nest.js</span>
          <span className='techDescription w-full mt-[20px]'>
      ...
      <div className='flex flex-row justify-between items-center w-full h-1/2'>
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>Docker</span>
          <span className='techDescription w-full mt-[20px]'>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>FireBase</span>
          <span className='techDescription w-full mt-[20px]'>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>GraphQl</span>
          <span className='techDescription w-full mt-[20px]'>
        ...
        <div className='w-[240px] h-[300px] flex flex-col px-[5px] justify-start items-start'>
          ...
          <span className='techName mt-[40px]'>Nginx</span>
          <span className='techDescription w-full mt-[20px]'>
