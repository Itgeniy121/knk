...
const WhyDoU = () => {
  return (
    <div className='container pt-5'>
      ...
      >
        <motion.h3
          className='relative max-w-max flex-col mt-5 flex items-center justify-center'
        ...
        >
          ...
          <span className='lg:text-[48px] sm:text-[38px] text-[30px] font-extrabold'>
            вашему бизнесу
          </span>
          <span className='lg:absolute xl:top-[-1px] top-[20px] outlined-text xl:right-[-285px] right-[-185px]'>
            САЙТ
          </span>
        ...
        >
          ...
          >
            ...
            <div className='flex-center flex-col'>
              ...
              <p className='mt-4 max-w-[550px] text-justify'>
                Одним из главных ключей к успеху вашего бизнеса является его
                доступность! И только благодаря личному сайту ваши клиенты
                найдут вас из любой точки мира.
              </p>
            </div>
          </motion.div>
        </motion.div>
          ...
          >
            ...
            <div className='flex-center flex-col'>
              ...
              <p className='mt-4 lg:max-w-[420px] max-w-[550px] text-justify'>
                Наличие сайта улучшает имидж вашей компании на фоне конкурентов
                и повышает доверие клиентов к вам.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div
            // className=' bg-[#171717] rounded-2xl p-4 flex-center flex-col why-card relative max-w-[500px]'
            // className='block rounded-md border-2 border-gray-200 bg-gray-0 p-6 pt-5 shadow-md shadow-black/5  max-w-[500px]'
            className='sm:items-start sm:justify-start flex justify-center w-full items-center relative z-10'
            variants={oddAnimation}
            custom={5}
          >
            <RiTimerFlashLine
            ...
            <div className='flex-center flex-col'>
              ...
              <p className='mt-4 max-w-[550px] text-justify'>
                Сайт может заменить традиционные методы рекламы, такие как
                буклеты, рекламные стенды, что позволяет сэкономить время и
                деньги.
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className='flex-center flex-col'>
              ...
              <p className='mt-4 lg:max-w-[420px] max-w-[550px] text-justify'>
                Сайт позволяет получать данные о посещаемости, поведении
                пользователей на сайте, что помогает управлять бизнесом и
